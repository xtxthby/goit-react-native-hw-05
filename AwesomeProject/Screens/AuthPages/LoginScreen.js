...
// Також для зручної роботи з навігацією у вкладених компонентах
// є спеціальні хуки, які витягують із контексту навігації необхідні
//  нам функції та параметри.
      ...
      >
        <ImageBackground source={backgroundImg} style={styles.bgContainer}>
          <View style={styles.contentWrapper}>
            ...
            {/* переход на іншу сторінку тут */}
            <TouchableOpacity style={styles.link} onPress={() => navigation.navigate('Regestration')}>
